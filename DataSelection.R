...
set.seed(6)  # Nustatome sėklą (angl. seed), kad būtų įmanoma atkartoti rezultatus
df_sampled <- df %>%
...
write.csv(df_sampled, "csv/atrinkti_duomenys_0918.csv", row.names = FALSE) # Išsaugome naują duomenų rinkinį į CSV failą